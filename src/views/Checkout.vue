<template>
  <div class="unautherized">
    <h3>
      You Need to login First <router-link to="login">Sign In</router-link>
    </h3>
  </div>
  <div class="autherized">
    <form @submit.prevent="checkout()">
      <div v-if="form.total_price > 0" class="checkoutContainer">
        <div class="cart">
      ...
      <div v-else>
        <h2>
          Your Cart is empty. <router-link to="/"> Go shoping Page</router-link>
        </h2>
      </div>
    </form>
  </div>
